...
$(".about_us_content p").addClass("wow fadeUp");


$("#services .icon-box").hover(function (){
    $(this).find('.some_content').css('display','none');
    $(this).find('.all_content').css('display','block');
}, function(){
    $(this).find('.all_content').css('display','none');
    $(this).find('.some_content').css('display','block');
});
